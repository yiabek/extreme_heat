...
years = [*range(1940, 2023, 1)]

## Loop through each year and load file
for year in years:

    ## Filename
    filename = f"T_daily_max_ERA5_historical_an-sfc_{year}0101_{year}1231_3sig.npy"
    labeled_array = np.load(filename)
